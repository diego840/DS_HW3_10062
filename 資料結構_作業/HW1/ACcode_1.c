...
int Node_list[MAX]; //main() 0
int Link_list[MAX][MAX]; //main() 0
int Req_list[max][3]; //main() 0
int visited[MAX]; //BFS() 0
int first_answer[MAX]; //BFS() 0
int test,a;
int answer_counter = 0;
int end_number[MAX]; //main() 0
int check_line[MAX]; //main() 0
int print_line[max][MAX]; //main() 0
int shortest_path[max][MAX];// main() 0

int END_list[max]; // main() 0
int hhhh = 0;
